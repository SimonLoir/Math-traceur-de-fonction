...
var down = false;
var start;
html_canvas.addEventListener('mousedown', function (e) {
    down = true;
    start = { x: e.pageX, y: e.pageY };
    html_canvas.style.cursor = "grabbing";
});
html_canvas.addEventListener('mousemove', function (e) {
    if (down == true) {
        var old = start;
...
html_canvas.addEventListener('mouseup', function (e) {
    down = false;
